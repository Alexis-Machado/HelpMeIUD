...
export default function Profile() {
    ...
    return (
        <div className="container">
            <h4 className="mb-9 neonperfil" style={{ textAlign: 'center', marginTop: '-99px', marginBottom: '10px', margin: '260px 0 10px 0' }}>
                Mi Perfil</h4>
                ...
                >
                    <div className="row g-3">
                        ...
                        <div className="col-12">
                            <label htmlFor="username" className="form-label">Correo <span className="text-muted"></span></label>
                            <input
                                autoComplete="off"
                                type="email"
                                className="form-control"
                    ...
                    <button
                        ...
                        type="submit"
                        className="btn btn-primary btn-lg button-standard mx-auto" // Agregando la clase mx-auto
                    >
                        {loading && (
                            <span
